...
5) IMPORTANT: Wait for the [ CI Job ](https://github.com/wikimedia/pixel-seed-data/runs/7156886305?check_suite_focus=true action) to pass before proceeding to the next step. It can take awhile (5 - 10 minutes) before the file is available to be downloaded.
