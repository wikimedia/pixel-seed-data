...
3) Drag and drop the file in the `backups` directory anywhere on this page (https://github.com/wikimedia/pixel-seed-data). Github will upload the file and ask you commit it to the main branch of this repo. Click "Commit changes".
