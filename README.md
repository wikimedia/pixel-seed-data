...
8) Pixel runs hourly reports via a cron job at [https://pixel.wmcloud.org/](https://pixel.wmcloud.org/). To make it use the new database image, ssh into its server, `cd` into `/srv/pixel`, and run `./pixel.js update`.
